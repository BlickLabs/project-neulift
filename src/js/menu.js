...
function doSomething(scroll_pos) {
  if (window.location.pathname === '/index.html' || window.location.pathname === '/' || window.location.pathname === '/project-neulift/index.html' || window.location.pathname === '/project-neulift/') {
    if (scroll_pos > 30) {
